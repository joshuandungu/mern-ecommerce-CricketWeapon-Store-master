...
export const createOrder = (order) => async (dispatch) => {
  try {
    ...
    dispatch({ type: CREATE_ORDER_FAIL, payload: error.response?.data?.message || error.message });
  }
};
...
export const myOrders = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: MY_ORDER_FAIL, payload: error.response?.data?.message || error.message });
  }
};
...
export const getAllOrders = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: ALL_ORDERS_FAIL, payload: error.response?.data?.message || error.message });
  }
};
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: DELETE_ORDER_FAIL, payload: error.response?.data?.message || error.message });
  }
};
...
export const updateOrder = (id, productData) => async (dispatch) => {
  try {
    ...
    dispatch({ type: UPDATE_ORDER_FAIL, payload: error.response?.data?.message || error.message });
  }
};
